...
HD_PWD='C:/Users/mahmo/OneDrive/Desktop/Project_1_DSP/vivado/proj2viv/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP_Project.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DSP_Project.tcl
