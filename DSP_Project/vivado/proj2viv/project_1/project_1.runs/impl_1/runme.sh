...
HD_PWD='C:/Users/mahmo/OneDrive/Desktop/Project_1_DSP/vivado/proj2viv/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP_Project.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DSP_Project.tcl -notrace
